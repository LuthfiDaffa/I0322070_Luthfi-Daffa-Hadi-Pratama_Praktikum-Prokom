...
utang = float(input('Masukkan jumlah utang: '))
bunga = float(input('Masukkan suku bunga tahunan: '))
lama_pinjaman = float(input('Masukkan lama pinjaman dalam tahun: '))
...
# Output
print('Cicilan pokok bulanan = ', cicilan_pokok_bulanan)
print('Cicilan bunga bulanan = ', cicilan_bunga_bulanan)
print('Total cicilan setiap bulan = ', total_cicilan_setiap_bulan)
